...
4. Finally, we came up with a solution to exclude LARs to fix that could not be fixed in future dashboards. We forced the values of all these LARs to "LOST". All queries can be found in `mark_lost_lars.sql`:
    - ig